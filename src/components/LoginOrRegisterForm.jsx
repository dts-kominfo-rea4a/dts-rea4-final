...
const LoginOrRegisterForm = ({ loginOrRegister }) => {
  ...
  return (
    ...
    >
      <Box className={styles.boxing} component="form" noValidate>
        <Typography variant="body1">
          {loginOrRegister === "login" ? "Masuk ke Akun" : "Buat Akun"}
        </Typography>
        ...
        {loginOrRegister === "login" ? (
          <Link to="/register">
            <Typography variant="body1">atau kamu ingin Buat Akun Baru?</Typography>
          </Link>
        ) : (
          <Link to="/login">
            <Typography variant="body1">atau kamu ingin Masuk ke Akun?</Typography>
          </Link>
        )}
      </Box>
    </Grid>
