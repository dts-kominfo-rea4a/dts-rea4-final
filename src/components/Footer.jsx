  ...
  return (
    ...
    <footer >
        <div className="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
            <div>
                <h2 className="mb-6 text-sm font-semibold text-gray-400">Company</h2>
            ...
            <div>
                <h2 className="mb-6 text-sm font-semibold text-gray-400">Help center</h2>
                <ul className="text-gray-400">
                    <li className="mb-4">
            ...
            <div>
                <h2 className="mb-6 text-sm font-semibold text-gray-400">Legal</h2>
                <ul className="text-gray-400">
                    <li className="mb-4">
            ...
            <div>
                <h2 className="mb-6 text-sm font-semibold text-gray-400">Download</h2>
                <ul className="text-gray-400">
                    <li className="mb-4">
        ...
        <div className="bg-gray-900 py-6 px-4 md:flex md:items-center md:justify-between">
            ...
            <div className="flex mt-4 space-x-6 sm:justify-center md:mt-0">                
                ...
                <a href="https://github.com/David-Top" target="_blank" className="text-gray-400 hover:text-white">
                ...
                <a href="https://david-top.github.io/" target="_blank" className="text-gray-400 hover:text-white">
