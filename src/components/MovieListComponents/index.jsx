...
const MovieListComponents = ({
	...
	return (
		...
		shadow-lg shadow-zinc-300 sm:ml-24 sm:w-fit sm:min-w-[75vw] xl:ml-60"
		>
			<div className="container mb-12 h-5/6 w-full bg-slate-50 pt-8 sm:p-4 ">
			 ...
			 grid-cols-2 justify-between  gap-x-8 gap-y-4 p-5 sm:grid-cols-3 sm:gap-x-4 xl:grid-cols-4 xl:gap-x-10"
				>
